...
void ModuleFonts::DrawText(int x, int y, int font_id, const char* text) const
{
	...
	{
		// TODO 2: Find the character in the table and its position in the texture, then DrawTexture
		uint charIndex = 0;
		...
		app->render->DrawTexture(font->texture, x, y, &spriteRect, SDL_FLIP_NONE, 0.0f);
